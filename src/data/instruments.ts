...
export const INSTRUMENTS: Instrument[] = [
  { id: 'piano', label: 'Concert piano', group: 'keys', soundfont: 'acoustic_grand_piano', program: 0, kind: 'melody', blurb: 'Salamander-style grand — the default for hummed songs.' },
  ...
  { id: 'choir', label: 'Choir aahs', group: 'synth', soundfont: 'choir_aahs', program: 52, kind: 'melody', blurb: 'Open-source choir vowels for hummed pads.' },
  { id: 'songbird-kit', label: 'SongBird kit', group: 'drums', soundfont: 'songbird-kit', program: 0, kind: 'drums', blurb: 'Built-in analog-style kit. Kick, snare, hats, toms, crash.' },
...
export const SOUNDFONT_CREDIT =
  'Instruments: MusyngKite / Fluid-style GM samples via midi-js-soundfonts (open soundfonts). Transcription and mix run on-device.'
